...
for_server = "/home/crisnotbrown/mobile_app_traffic_hazard_web/"
...
def tags_get():
    res = []
    dir_path = "/home/crisnotbrown/mobile_app_traffic_hazard_web/assets/"
    # Iterate directory
    for path in os.listdir(dir_path):
        # check if current path is a file
        if os.path.isfile(os.path.join(dir_path, path)):
            f = open(f"/home/crisnotbrown/mobile_app_traffic_hazard_web/assets/{path}","r")
...
def save_ble():
    ...
    f = open(f"/home/crisnotbrown/mobile_app_traffic_hazard_web/assets/{codes}","w")
    f.write(json.dumps(dict(request.form)))
    return "finished"

@app.route('/del_ble/<code>',methods=["POST","GET"])
def del_ble(code):
    os.remove("/home/crisnotbrown/mobile_app_traffic_hazard_web/assets/"+code)
    return "finished"
